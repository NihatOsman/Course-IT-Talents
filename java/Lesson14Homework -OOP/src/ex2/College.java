...
public class College {
		...
		public static void main(String[] args) {
			...
			student1.receiveScholarShip(student1.getGrade(), 100);
			Student student2 = new Student("Petko","Biologiq",22);
			student2.setGrade(3.50);
			student2.receiveScholarShip(student2.getGrade(), 100);//no schoolar ship for students with smaller than 4.00 grade
